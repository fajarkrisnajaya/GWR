...
x1 = data$Curah_hujan 
x2 = data$Hari_hujan 
x3 = data$Kecepatan_angin
x4 = data$Kelembaban
x5 = data$Tekanan_udara
x6 = data$Penyinaran_matahari

# Regresi Linier Berganda
#Model Regresi OLS
model_linier = lm(formula = y~x1+x2+x3+x4+x5+x6, data = data)
...
peta 
df = data
colnames(df)[1] <- "NAME_1"
df
peta = merge(peta,df, by.x = "NAME_1", by.y = "NAME_1")
peta
